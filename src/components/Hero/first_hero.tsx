        ...
        <div className={`h-screen w-screen grid grid-cols-3 ${!showContent ? 'pointer-events-none' : ""}`}>
            {
                source.map((item, index) => {
                    return <div className="relative" onMouseEnter={() => setIsHovered(index)} onMouseLeave={() => setIsHovered(null)}>
